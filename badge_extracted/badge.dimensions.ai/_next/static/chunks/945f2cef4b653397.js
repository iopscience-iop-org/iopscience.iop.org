...
! function() {
    try {
        var e = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && ((e._debugIds || (e._debugIds = {}))[n] = "9ddf3d16-e463-bae8-7990-96b9810aafb8")
    } catch (e) {}
}();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 23288, 91401, 25304, 1020, t => {
    "use strict";
    let e = "10.38.0";
    t.s(["SDK_VERSION", () => e], 91401);
    let n = globalThis;
    ...
    t.s(["GLOBAL_OBJ", () => n], 25304), t.s(["getGlobalSingleton", () => s, "getMainCarrier", () => r, "getSentryCarrier", () => i], 23288);
    let a = "u" < typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__;
    t.s(["DEBUG_BUILD", () => a], 1020)
}, 72598, t => {
    "use strict";
    var e = t.i(23288),
        n = t.i(1020),
    ...
    t.s(["isDOMError", () => s, "isDOMException", () => a, "isElement", () => d, "isError", () => n, "isErrorEvent", () => i, "isEvent", () => p, "isInstanceOf", () => g, "isParameterizedString", () => c, "isPlainObject", () => l, "isPrimitive", () => u, "isRegExp", () => f, "isRequest", () => S, "isString", () => o, "isSyntheticEvent", () => h, "isThenable", () => _, "isVueViewModel", () => m], 53288);
    let y = t.i(25304).GLOBAL_OBJ;
    ...
    t.s(["getComponentName", () => v, "getLocationHref", () => E, "htmlTreeAsString", () => b], 3798)
}, 62537, 51497, 11139, 36032, 21593, 82564, 5394, 41041, 18746, 73382, 21061, 1263, 50804, 19988, 2309, 10008, 70637, 76710, 39435, 32584, 4661, 73250, 73753, 28469, 45968, 67486, 54300, 69766, 4478, 14177, 41193, 80611, 71993, 13186, t => {
    "use strict";
    let e, n, r, i, s, a, o;
    var c = t.i(23288),
        u = t.i(1020),
    ...
    t.s(["addNonEnumerableProperty", () => _, "convertToPlainObject", () => m, "extractExceptionKeysForMessage", () => b, "fill", () => f, "getOriginalFunction", () => g, "markFunctionWrapped", () => h], 51497);
    var E = t.i(25304);
    ...
    t.s(["safeDateNow", () => I, "safeMathRandom", () => T, "withRandomSafeContext", () => v], 11139);
    let x = /\(error: (.*)\)/,
    ...
    function C(...t) {
        ...
        return (t, n = 0, r = 0) => {
            ...
            if (!a.length) return [];
            let o = Array.from(a);
            return /sentryWrapped/.test(D(o).function || "") && o.pop(), o.reverse(), A.test(D(o).function || "") && (o.pop(), A.test(D(o).function || "") && o.pop()), o.slice(0, 50).map(t => ({ ...t,
                filename: t.filename || D(o).filename,
                function: t.function || "?"
            }))
        }
    }
    ...
    function z() {
        return (r ? ? (r = function() {
            ...
            if (!t ? .now || !t.timeOrigin) return Y;
            let e = t.timeOrigin;
            return () => (e + v(() => t.now())) / 1e3
        }()))()
    }
    t.s(["UNKNOWN_FUNCTION", () => "?", "createStackParser", () => C, "getFramesFromEvent", () => w, "getFunctionName", () => N, "getVueInternalName", () => L, "normalizeStackTracePath", () => R, "stackParserFromStackParserOptions", () => O], 36032), t.s(["isMatchingPattern", () => M, "safeJoin", () => P, "snipLine", () => U, "stringMatchesSomePattern", () => $, "truncate", () => B], 21593), t.s(["addExceptionMechanism", () => H, "addExceptionTypeValue", () => J, "checkOrSetAlreadyCaught", () => V, "getEventDescription", () => F, "uuid4", () => j], 82564);
    let K = null;

    function W() {
        return null === K && (K = function() {
            let {
                performance: t
            } = E.GLOBAL_OBJ;
            if (!t ? .now) return;
    ...
    function X(t, e = {}) {
        if (e.user && (!t.ipAddress && e.user.ip_address && (t.ipAddress = e.user.ip_address), t.did || e.did || (t.did = e.user.id || e.user.email || e.user.username)), t.timestamp = e.timestamp || z(), e.abnormal_mechanism && (t.abnormal_mechanism = e.abnormal_mechanism), e.ignoreDuration && (t.ignoreDuration = e.ignoreDuration), e.sid && (t.sid = 32 === e.sid.length ? e.sid : j()), void 0 !== e.init && (t.init = e.init), !t.did && e.did && (t.did = `${e.did}`), "number" == typeof e.started && (t.started = e.started), t.ignoreDuration) t.duration = void 0;
    ...
    function Z(t, e, n = 2) {
        ...
        for (let t in e) Object.prototype.hasOwnProperty.call(e, t) && (r[t] = Z(r[t], e[t], n - 1));
        return r
    }
    ...
    t.s(["browserPerformanceTimeOrigin", () => W, "dateTimestampInSeconds", () => Y, "timestampInSeconds", () => z], 5394), t.s(["closeSession", () => Q, "makeSession", () => q, "updateSession", () => X], 41041), t.s(["merge", () => Z], 18746), t.s(["generateSpanId", () => te, "generateTraceId", () => tt], 73382);
    let tn = "_sentrySpan";

    function tr(t, e) {
        e ? _(t, tn, e) : delete t[tn]
    }

    function ti(t) {
        return t[tn]
    }
    t.s(["_getSpanForScope", () => ti, "_setSpanForScope", () => tr], 21061);
    class ts {
        constructor() {
        ...
        clone() {
            ...
            }, t._client = this._client, t._lastEventId = this._lastEventId, t._conversationId = this._conversationId, tr(t, this[tn]), t
        }
        setClient(t) {
            this._client = t
        }
            ...
            let e = "function" == typeof t ? t(this) : t,
                {
                    ...
                    conversationId: l
                } = (e instanceof ts ? e.getScopeData() : (0, d.isPlainObject)(e) ? t : void 0) || {};
            return this._tags = { ...this._tags,
                ...n
        ...
        clear() {
            return this._breadcrumbs = [], this._tags = {}, this._attributes = {}, this._extra = {}, this._user = {}, this._contexts = {}, this._level = void 0, this._transactionName = void 0, this._fingerprint = void 0, this._session = void 0, this._conversationId = void 0, tr(this, void 0), this._attachments = [], this.setPropagationContext({
                traceId: tt(),
                sampleRand: T()
            }), this._notifyScopeListeners(), this
        }
        ...
        setSDKProcessingMetadata(t) {
            return this._sdkProcessingMetadata = Z(this._sdkProcessingMetadata, t, 2), this
        }
    ...
    class ta {
        constructor(t, e) {
            let n, r;
            n = t || new ts, r = e || new ts, this._stack = [{
                scope: n
    ...
    function to() {
        ...
        return e.stack = e.stack || new ta((0, c.getGlobalSingleton)("defaultCurrentScope", () => new ts), (0, c.getGlobalSingleton)("defaultIsolationScope", () => new ts))
    }

    function tc(t) {
        return to().withScope(t)
    }
    ...
    function tl(t) {
        return to().withScope(() => t(to().getIsolationScope()))
    }

    function tp(t) {
        let e = (0, c.getSentryCarrier)(t);
        return e.acs ? e.acs : {
            withIsolationScope: tl,
            withScope: tc,
            withSetScope: tu,
            withSetIsolationScope: (t, e) => tl(e),
            getCurrentScope: () => to().getScope(),
            getIsolationScope: () => to().getIsolationScope()
        }
    }

    function td() {
        return tp((0, c.getMainCarrier)()).getCurrentScope()
    }

    function tf() {
        return tp((0, c.getMainCarrier)()).getIsolationScope()
    }

    function t_() {
        return (0, c.getGlobalSingleton)("globalScope", () => new ts)
    }

    function th(...t) {
        let e = tp((0, c.getMainCarrier)());
        if (2 === t.length) {
            let [n, r] = t;
    ...
    function tN(t) {
        let e = tL(t);
        if (!e) return;
        let n = Object.entries(e).reduce((t, [e, n]) => (e.match(tk) && (t[e.slice(tD.length)] = n), t), {});
    ...
    function tL(t) {
        if (t && ((0, d.isString)(t) || Array.isArray(t))) return Array.isArray(t) ? t.reduce((t, e) => (Object.entries(tR(e)).forEach(([e, n]) => {
            t[e] = n
        }), t), {}) : tR(t)
    }
    ...
    t.s(["SENTRY_BAGGAGE_KEY_PREFIX", () => tD, "baggageHeaderToDynamicSamplingContext", () => tN, "dynamicSamplingContextToSentryBaggageHeader", () => tw, "parseBaggageHeader", () => tL], 2309), t.s(["hasSpansEnabled", () => tB], 10008), t.s(["parseSampleRate", () => tU], 70637), t.s(["SPAN_STATUS_ERROR", () => 2, "SPAN_STATUS_OK", () => 1, "SPAN_STATUS_UNSET", () => 0, "setHttpStatus", () => tP], 76710);
    let tM = "_sentryScope",
    ...
    function tY(t) {
        ...
        if (n.orgId) e = String(n.orgId);
            ...
            let t;
            r && (t = r.match(tG), e = t ? .[1])
        }
        return e
    }

    function tz(t) {
        let e = "string" == typeof t ? tH(t) : tV(t);
        if (e && function(t) {
    ...
    t.s(["dsnFromString", () => tH, "dsnToString", () => tJ, "extractOrgIdFromClient", () => tY, "makeDsn", () => tz], 39435);
    ...
    function tW(t, e) {
        ...
        let i = function(t, e) {
            let n = tU(e ? .sample_rand);
            if (void 0 !== n) return n;
            let r = tU(e ? .sample_rate);
    ...
    function tq(t = tt(), e = te(), n) {
        let r = "";
        return void 0 !== n && (r = n ? "-1" : "-0"), `${t}-${e}${r}`
    }

    function tX(t = tt(), e = te(), n) {
    ...
    t.s(["TRACEPARENT_REGEXP", () => tK, "generateSentryTraceHeader", () => tq, "generateTraceparentHeader", () => tX, "propagationContextFromHeaders", () => tW, "shouldContinueTrace", () => tQ], 32584);
    let tZ = !1;
    ...
    function t1(t) {
        let {
            ...
            traceId: n,
            isRemote: r
        } = t.spanContext(), i = r ? e : t6(t).parent_span_id, s = tj(t).scope;
        return {
            parent_span_id: i,
            span_id: r ? s ? .getPropagationContext().propagationSpanId || te() : e,
            trace_id: n
        }
    }
    ...
    function t8(t) {
        return "number" == typeof t ? t5(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? t5(t.getTime()) : z()
    }
    ...
    function en(t, e) {
        let n = t[ee] || t;
        _(e, ee, n), t[et] ? t[et].add(e) : _(t, et, new Set([e]))
    }
    ...
    function ei(t) {
        ...
        return ! function t(n) {
            if (!e.has(n) && t9(n))
                for (let r of (e.add(n), n[et] ? Array.from(n[et]) : [])) t(r)
        }(t), Array.from(e)
    }
    ...
    function ef(t) {
        ...
        let n = es(t),
            ...
            a = s ? .get("sentry.sample_rate") ? ? i[tb] ? ? i[tE];
        ...
        let u = s ? .get("sentry.dsc"),
            l = u && tN(u);
        if (l) return o(l);
        let p = ep(t.spanContext().traceId, e),
            d = i[ty],
            f = r.description;
        return "url" !== d && f && (p.transaction = f), tB() && (p.sampled = String(t9(n)), p.sample_rand = s ? .get("sentry.sample_rand") ? ? tj(n).scope ? .getPropagationContext().sampleRand.toString()), o(p), e.emit("createDsc", p, n), p
    }
    t.s(["freezeDscOnSpan", () => el, "getDynamicSamplingContextFromScope", () => ed, "getDynamicSamplingContextFromSpan", () => ef], 73753);
    class e_ {
        constructor(t = {}) {
            this._traceId = t.traceId || tt(), this._spanId = t.spanId || te()
        }
        spanContext() {
            return {
                spanId: this._spanId,
    ...
    function eh(e, n = 100, r = Infinity) {
        try {
    ...
    function eE(t) {
        ...
        function i(t) {
            "string" == typeof r ? r = "string" == typeof t ? r + t : [eb(r), t] : r.push("string" == typeof t ? eb(t) : t)
        }
        for (let t of n) {
            let [e, n] = t;
            if (i(`
...
`), "string" == typeof n || n instanceof Uint8Array) i(n);
    ...
    function eT(t) {
        let e = "string" == typeof t.data ? eb(t.data) : t.data;
        return [{
            type: "attachment",
            length: e.length,
            filename: t.filename,
    ...
    t.s(["SentryNonRecordingSpan", () => e_], 28469), t.s(["normalize", () => eh, "normalizeToSize", () => function t(e, n = 3, r = 102400) {
        let i = eh(e, n);
    ...
    function eD(t, e) {
        ...
        for (let r of e) {
            ...
            if ("string" == typeof(n = r) || n instanceof RegExp) {
                if (M(t.description, r)) return u.DEBUG_BUILD && eO(t), !0;
                continue
            }
            if (!r.name && !r.op) continue;
            let e = !r.name || M(t.description, r.name),
                i = !r.op || t.op && M(t.op, r.op);
            if (e && i) return u.DEBUG_BUILD && eO(t), !0
        }
        return !1
    }
    ...
    function ew(t, e, n, r) {
        ...
        ! function(t, e) {
            ...
            t.sdk = { ...n,
                ...
                settings: t.sdk ? .settings || e.settings ? { ...t.sdk ? .settings,
                    ...e.settings
                } : void 0
            }
        }(t, n ? .sdk);
        let a = eC(t, i, r, e);
        return delete t.sdkProcessingMetadata, eg(a, [
            [{
                type: s
            }, t]
        ])
    ...
    function eL(t, e) {
        let n = ef(t[0]),
            ...
            c = o ? .length ? t.filter(t => !eD(t6(t), o)) : t,
            u = t.length - c.length;
    ...
    t.s(["addItemToEnvelope", () => em, "createAttachmentEnvelopeItem", () => eT, "createEnvelope", () => eg, "createEventEnvelopeHeaders", () => eC, "createSpanEnvelopeItem", () => ev, "envelopeContainsItemType", () => ey, "envelopeItemTypeToDataCategory", () => ex, "forEachEnvelopeItem", () => eS, "getSdkMetadataForEnvelopeHeader", () => eA, "serializeEnvelope", () => eE], 67486), t.s(["reparentChildSpans", () => ek, "shouldIgnoreSpan", () => eD], 54300), t.s(["createEventEnvelope", () => ew, "createSessionEnvelope", () => eN, "createSpanEnvelope", () => eL], 69766), t.s(["setMeasurement", () => eR, "timedEventsToMeasurements", () => eB], 4478);
    class eU {
        constructor(t = {}) {
            this._traceId = t.traceId || tt(), this._spanId = t.spanId || te(), this._startTime = t.startTimestamp || z(), this._links = t.links, this._attributes = {}, this.setAttributes({
                [tT]: "manual",
                [tv]: t.op,
                ...t.attributes
        ...
        updateName(t) {
            return this._name = t, this.setAttribute(ty, "custom"), this
        }
        end(t) {
            this._endTime || (this._endTime = t8(t), function(t) {
                ...
                let {
                    ...
                    spanId: r
                } = t.spanContext(), i = es(t) === t, s = `[Tracing] Finishing "${n}" ${i?"root ":""}span "${e}" with ID ${r}`;
                p.debug.log(s)
        ...
        getSpanJSON() {
            return {
                ...
                op: this._attributes[tv],
                parent_span_id: this._parentSpanId,
                span_id: this._spanId,
                start_timestamp: this._startTime,
                status: t7(this._status),
                timestamp: this._endTime,
                trace_id: this._traceId,
                origin: this._attributes[tT],
                profile_id: this._attributes[tC],
                exclusive_time: this._attributes[tO],
                measurements: eB(this._events),
                is_segment: this._isStandaloneSpan && es(this) === this || void 0,
                segment_id: this._isStandaloneSpan ? es(this).spanContext().spanId : void 0,
                links: t4(this._links)
            }
        }
        isRecording() {
        ...
        _onSpanEnded() {
            let t = tm();
            if (t && t.emit("spanEnd", this), !(this._isStandaloneSpan || this === es(this))) return;
            ...
            }(eL([this], t)) : (u.DEBUG_BUILD && p.debug.log("[Tracing] Discarding standalone span because its trace was not chosen to be sampled."), t && t.recordDroppedEvent("sample_rate", "span")));
            let e = this._convertSpanToTransaction();
            e && (tj(this).scope || td()).captureEvent(e)
        }
        _convertSpanToTransaction() {
            if (!eM(t6(this))) return;
            ...
            let {
                scope: t,
                isolationScope: e
            } = tj(this), n = t ? .getScopeData().sdkProcessingMetadata ? .normalizedRequest;
            if (!0 !== this._sampled) return;
            let r = ei(this).filter(t => {
                    var e;
                    return t !== this && !((e = t) instanceof eU && e.isStandaloneSpan())
                }).map(t => t6(t)).filter(eM),
                i = this._attributes[ty];
            delete this._attributes[tA], r.forEach(t => {
                delete t.data[tA]
            });
            let s = {
                    contexts: {
    ...
    function ej(t, e) {
        ...
        return th(a ? .clone(), () => {
            var n;
            return (void 0 !== (n = s) ? t => eF(n, t) : t => t())(() => {
                let n = td(),
                    a = eK(n, s),
                    o = t.onlyIfParent && !a ? new e_ : eH({
                        parentSpan: a,
                        spanArguments: r,
                        forceTransaction: i,
                        scope: n
    ...
    function eG(t) {
        ...
        return (t.scope ? e => th(t.scope, e) : void 0 !== i ? t => eF(i, t) : t => t())(() => {
            let e = td(),
                s = eK(e, i);
            return t.onlyIfParent && !s ? new e_ : eH({
                parentSpan: s,
                spanArguments: n,
                forceTransaction: r,
                scope: e
    ...
    function eF(t, e) {
        let n = eY();
        return n.withActiveSpan ? n.withActiveSpan(t, e) : th(n => (tr(n, t || void 0), e(n)))
    }

    function eJ(t) {
        return th(e => (e.setPropagationContext({
            traceId: tt(),
            sampleRand: T()
        }), u.DEBUG_BUILD && p.debug.log(`Starting a new trace with id ${e.getPropagationContext().traceId}`), eF(null, t)))
    }
    ...
    function eH({
        ...
        if (t && !n) s = function(t, e, n) {
            let {
                spanId: r,
                traceId: i
            } = t.spanContext(), s = !e.getScopeData().sdkProcessingMetadata[e$] && t9(t), a = s ? new eU({ ...n,
                parentSpanId: r,
                traceId: i,
                sampled: s
            }) : new e_({
        ...
        return ! function(t) {
            ...
            let {
                ...
                spanId: i
            } = t.spanContext(), s = t9(t), a = es(t), o = a === t, c = `[Tracing] Starting ${s?"sampled":"unsampled"} ${o?"root ":""}span`, l = [`op: ${n}`, `name: ${e}`, `ID: ${i}`];
  ...
  ${l.join("\n  ")}`)
    ...
    function ez(t, e, n) {
        ...
        let o = a.parentSampled ? ? n,
            ...
            [d, f, _] = e.getScopeData().sdkProcessingMetadata[e$] ? [!1] : function(t, e, n) {
                let r, i;
                if (!tB(t)) return [!1];
                "function" == typeof t.tracesSampler ? (r = t.tracesSampler({ ...e,
                ...
                parentSampled: o,
                attributes: c,
                parentSampleRate: tU(l.dsc ? .sample_rate)
            }, l.sampleRand),
            h = new eU({ ...t,
                attributes: {
                    [ty]: "custom",
                    [tb]: void 0 !== f && _ ? f : void 0,
                    ...c
                },
                sampled: d
            });
    ...
    function eK(t, e) {
        ...
        if (!n) return;
        let r = tm();
        return (r ? r.getOptions() : {}).parentSpanIsAlwaysRootSpan ? es(n) : n
    }
    ...
    t.s(["startInactiveSpan", () => eG, "startNewTrace", () => eJ, "startSpan", () => ej, "withActiveSpan", () => eF], 41193);
    class eX {
        constructor(t) {
    ...
    function eQ(t, e) {
        ...
        (function(t, e) {
            ...
            dynamicSamplingContext: ef(r),
            ...n.sdkProcessingMetadata
        }, (l = t6(es(r)).description) && !n.transaction && "transaction" === n.type && (n.transaction = l)), i = t, s = d, i.fingerprint = i.fingerprint ? Array.isArray(i.fingerprint) ? i.fingerprint : [i.fingerprint] : [], s && (i.fingerprint = i.fingerprint.concat(s)), i.fingerprint.length || delete i.fingerprint, a = t, o = _, p = [...a.breadcrumbs || [], ...o], a.breadcrumbs = p.length ? p : void 0, c = t, u = h, c.sdkProcessingMetadata = { ...c.sdkProcessingMetadata,
            ...u
        }
    }
    ...
    function eZ(t, e) {
        ...
        e0(t, "extra", n), e0(t, "tags", r), e0(t, "attributes", i), e0(t, "user", s), e0(t, "contexts", a), t.sdkProcessingMetadata = Z(t.sdkProcessingMetadata, c, 2), o && (t.level = o), _ && (t.transactionName = _), h && (t.span = h), u.length && (t.breadcrumbs = [...t.breadcrumbs, ...u]), l.length && (t.fingerprint = [...t.fingerprint, ...l]), p.length && (t.eventProcessors = [...t.eventProcessors, ...p]), d.length && (t.attachments = [...t.attachments, ...d]), t.propagationContext = { ...t.propagationContext,
            ...f
        }
    }
    ...
    function e1(t, e) {
        let n = t_().getScopeData();
        return t && eZ(n, t.getScopeData()), e && eZ(n, e.getScopeData()), n
    }

    function e3(t, e, n, r, c, l) {
        var f, _, h;
        let g, {
                normalizeDepth: m = 3,
        ...
        (function(t, e) {
            ...
            t.environment = t.environment || n || ec, !t.release && r && (t.release = r), !t.dist && i && (t.dist = i);
            let a = t.request;
            a ? .url && s && (a.url = B(a.url, s)), s && t.exception ? .values ? .forEach(t => {
                t.value && (t.value = B(t.value, s))
            })
        })(y, t), f = y, (_ = b).length > 0 && (f.sdk = f.sdk || {}, f.sdk.integrations = [...f.sdk.integrations || [], ..._]), c && c.emit("applyFrameMetadata", e), void 0 === e.type && (h = y, g = function(t) {
        ...
        }(t.stackParser), h.exception ? .values ? .forEach(t => {
            t.stacktrace ? .frames ? .forEach(t => {
                t.filename && (t.debug_id = g[t.filename])
            })
        }));
        let v = function(t, e) {
            if (!e) return t;
            let n = t ? t.clone() : new ts;
            return n.update(e), n
        }(r, n.captureContext);
        n.mechanism && H(y, n.mechanism);
        let T = c ? c.getEventProcessors() : [],
            I = e1(l, v),
            x = [...n.attachments || [], ...I.attachments];
        return x.length && (n.attachments = x), eQ(y, I), (function(t, e, n, r = 0) {
            try {
                ...
                return (0, d.isThenable)(i) ? i : eW(i)
            } catch (t) {
                return eq(t)
            }
        })([...T, ...I.eventProcessors], y, n).then(t => (t && function(t) {
            let e = {};
            ...
            let r = { ...t,
                ...
                ...t.contexts && {
                    contexts: eh(t.contexts, e, n)
                },
                ...t.extra && {
                    extra: eh(t.extra, e, n)
                }
            };
            return t.contexts ? .trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = eh(t.contexts.trace.data, e, n))), t.spans && (r.spans = t.spans.map(t => ({ ...t,
                ...t.data && {
                    data: eh(t.data, e, n)
                }
            }))), t.contexts ? .flags && r.contexts && (r.contexts.flags = eh(t.contexts.flags, 3, n)), r
        }(t, m, S) : t)
    }
    ...
    function e2(t) {
        if (t) {
            var e;
            return (e = t) instanceof ts || "function" == typeof e || Object.keys(t).some(t => e4.includes(t)) ? {
                captureContext: t
            } : t
        }
    }
    t.s(["rejectedSyncPromise", () => eq, "resolvedSyncPromise", () => eW], 80611), t.s(["applyScopeDataToEvent", () => eQ, "getCombinedScopeData", () => e1], 71993);
    let e4 = ["user", "level", "extra", "contexts", "tags", "fingerprint", "propagationContext"];

    function e8(t, e) {
        return td().captureException(t, e2(e))
    }
    ...
    t.s(["parseEventHintOrCaptureContext", () => e2, "prepareEvent", () => e3], 13186), t.s(["addEventProcessor", () => e7, "captureEvent", () => e5, "captureException", () => e8, "captureSession", () => nr, "isEnabled", () => e9, "setContext", () => e6, "startSession", () => nt], 62537)
}]);

//# debugId=9ddf3d16-e463-bae8-7990-96b9810aafb8
//# sourceMappingURL=f36fb1c41a19d064.js.map